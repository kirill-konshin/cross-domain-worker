...
self.onmessage = ({data: {msg, payload}}) => {
    if (msg === 'base') {
        ...
        console.log('Image', image, 'should be http://localhost:4001/test/...'); // returns http://localhost:3000/xxx.png, should be http://localhost:4001/test/...
        console.log('__webpack_public_path__', __webpack_public_path__, 'should be http://localhost:4001/test/'); // returns http://localhost:3000/, should be http://localhost:4001/test/
